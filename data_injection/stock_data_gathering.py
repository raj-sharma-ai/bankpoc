...
class LiveStockAnalyzer:
    ...
    # def calculate_risk_bucket(self):
    #     """Calculate risk bucket - STRICT VERSION"""
    #     risk_score = 0
    #     risk_flags = []
    ...
    #         if beta > 1.5:
    #             risk_score += 35
    #             risk_flags.append(f"Beta:{beta:.2f}")
    #         elif beta > 1.2:
    #             risk_score += 22
    #         elif beta > 1.0:
    #             risk_score += 12
    ...
    #     # Volatility (35 points max)
    #     vol = self.calculate_volatility()
    #     vol_90d = vol.get('volatility_90d')
    #     if vol_90d:
    #         if vol_90d > 60:
    #             risk_score += 35
    #             risk_flags.append(f"Vol:{vol_90d:.1f}%")
    #         elif vol_90d > 45:
    #             risk_score += 28
    #             risk_flags.append(f"Vol:{vol_90d:.1f}%")
    #         elif vol_90d > 35:
    ...
    #     # Drawdown (20 points max)
    #     if self.hist is not None and len(self.hist) > 0:
    #         cumulative = (1 + self.hist['Close'].pct_change()).cumprod()
    #         running_max = cumulative.expanding().max()
    ...
    #         if max_dd < -50:
    #             risk_score += 20
    #             risk_flags.append(f"DD:{max_dd:.1f}%")
    #         elif max_dd < -35:
    #             risk_score += 15
    #         elif max_dd < -25:
    #             risk_score += 10
    ...
    #     # Return volatility (10 points max)
    #     returns = self.calculate_returns()
    #     return_1y = returns.get('return_1y', 0)
    #     if return_1y:
    #         if abs(return_1y) > 100:
    #             risk_score += 10
    #             risk_flags.append(f"Ret:{return_1y:.1f}%")
    #         elif abs(return_1y) > 60:
    #             risk_score += 7
    #         else:
    #             risk_score += 3
    ...
    #     if risk_score >= 60:
    #         risk_level = 'High'
    #         print(f"\n   ⚠️  HIGH RISK: {risk_score} pts - {', '.join(risk_flags)}")
    #     elif risk_score >= 35:
    #         risk_level = 'Medium'
    #     else:
    #         risk_level = 'Low'
